...
//   if (cart.length === 0) return <p className="text-center mt-20">Your cart is empty.</p>;
...
//         </div>
//       ))}
//       <h2>Total: {currency === "INR" ? `₹${(total * usdToInr).toFixed(2)}` : `$${total}`}</h2>
//       <button className="px-4 py-2 bg-green-600 text-white rounded mt-2">Checkout</button>
//     </div>
//   );
// }
